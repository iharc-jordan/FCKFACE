...
[FEI](https://fei.edu.br/~cet/facedatabase.html) is research-use data, not an application asset. Acquisition and identity deduplication are pending. Less controlled permitted photographs are also required before broader real-world claims. Never copy research images or embeddings into the public application.
